            ...
            while (menu != 0) {
                ...
                switch (menu) {
                    ...
                    case 3:
                        ...
                        queryResults = storeHelper.findByStoreType(storetype);
                        printResultRows(queryResults);
                        break;
                    case 4:
                        ...
                        System.out.println("You've selected to find all stores with a specific city and state. Please enter the state:");
